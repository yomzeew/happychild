...
export const addrateUrl=`${BaseURi}/addrate`
export const getrateAll=`${BaseURi}/getrateall`
export const getratebygroupUrl=`${BaseURi}/getratebygroup`
export const addbankdetailsUrl=`${BaseURi}/insertbankdetails`
export const getbankdetailsUrl=`${BaseURi}/getbankdetails`
export const contactCenterUrl=`${BaseURi}/contactcenter`
export const getallbookUrl=`${BaseURi}/getallbook`
export const getallchildUrl=`${BaseURi}/childallrec`
